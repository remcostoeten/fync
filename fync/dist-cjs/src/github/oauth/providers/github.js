...
exports.GITHUB_OAUTH2_SCOPES = exports.GITHUB_OAUTH2_PROVIDER = void 0;
exports.getCommonScopeGroups = getCommonScopeGroups;
exports.validateGitHubScopes = validateGitHubScopes;
const GITHUB_OAUTH2_PROVIDER = exports.GITHUB_OAUTH2_PROVIDER = {
  name: "github",
...
const GITHUB_OAUTH2_SCOPES = exports.GITHUB_OAUTH2_SCOPES = {
...
function getCommonScopeGroups() {
  return {
    READ_ONLY: [GITHUB_OAUTH2_SCOPES.USER_EMAIL, GITHUB_OAUTH2_SCOPES.PUBLIC_REPO, GITHUB_OAUTH2_SCOPES.READ_DISCUSSION, GITHUB_OAUTH2_SCOPES.READ_PACKAGES, GITHUB_OAUTH2_SCOPES.READ_PROJECT],
    READ_WRITE: [GITHUB_OAUTH2_SCOPES.USER_EMAIL, GITHUB_OAUTH2_SCOPES.REPO_READ, GITHUB_OAUTH2_SCOPES.GIST, GITHUB_OAUTH2_SCOPES.NOTIFICATIONS, GITHUB_OAUTH2_SCOPES.WORKFLOW],
    ADMIN: [GITHUB_OAUTH2_SCOPES.USER_EMAIL, GITHUB_OAUTH2_SCOPES.REPO_WRITE, GITHUB_OAUTH2_SCOPES.ADMIN_READ_ORG, GITHUB_OAUTH2_SCOPES.ADMIN_WRITE_ORG, GITHUB_OAUTH2_SCOPES.ADMIN_READ_REPO_HOOK, GITHUB_OAUTH2_SCOPES.ADMIN_WRITE_REPO_HOOK, GITHUB_OAUTH2_SCOPES.DELETE_REPO, GITHUB_OAUTH2_SCOPES.WORKFLOW]
  };
}