...
declare function buildSimple(
	user: TGitHubUser,
	repos: TGitHubRepository[],
): TSimpleResponse;
declare function buildStructured(
	user: TGitHubUser,
	repos: TGitHubRepository[],
): TStructuredResponse;
declare function buildFluent(
	user: TGitHubUser,
	repos: TGitHubRepository[],
): TFluentResponse;
...
declare function buildSuccessResponse<T>(
	data: T[],
	options?: TResponseBuilderOptions,
): TApiResponse<T[]>;
declare function buildErrorResponse(
	message: string,
	code: string,
	details?: Record<string, unknown>,
): TErrorResponse;
...
declare function paginateData<T>(
	data: T[],
	page: number,
	per_page: number,
): T[];
