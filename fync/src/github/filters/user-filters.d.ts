...
declare function filterUsersByType(
	users: TGitHubUser[],
	type: "User" | "Organization",
): TGitHubUser[];
declare function filterUsersByFollowers(
	users: TGitHubUser[],
	min?: number,
	max?: number,
): TGitHubUser[];
declare function filterUsersByPublicRepos(
	users: TGitHubUser[],
	min?: number,
	max?: number,
): TGitHubUser[];
declare function filterUsersByLocation(
	users: TGitHubUser[],
	location: string,
): TGitHubUser[];
declare function filterUsersByCompany(
	users: TGitHubUser[],
	company: string,
): TGitHubUser[];
declare function filterUserFields(
	user: TGitHubUser,
	filter: TUserFieldFilter,
): Partial<TGitHubUser>;
declare function filterUsers(
	users: TGitHubUser[],
