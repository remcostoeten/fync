...
function createOAuth2Flow(
	...
	function generateState(metadata?: Record<string, unknown>): TOAuth2State {
	...
	function getAuthorizationUrl(
		options: TOAuth2AuthorizationUrlOptions,
	): string {
	...
	async function revokeToken(options: TOAuth2RevokeOptions): Promise<void> {
