...
describe('createCalendarService', () => {
  ...
  describe('getCalendars', () => {
    it('fetches user calendars', async () => {
      ...
      mockCalendarClient.users.me.calendarList.get.mockResolvedValue(mockResponse);
  ...
  describe('getEvents', () => {
    it('fetches events from primary calendar by default', async () => {
      ...
      expect(mockCalendarClient.calendars.primary.events.get).toHaveBeenCalledWith({
        params: undefined
      });
  ...
  describe('isTimeSlotBusy', () => {
    it('returns true when time slot is busy', async () => {
      ...
      const service = createCalendarService(mockConfig);
      const isBusy = await service.isTimeSlotBusy('primary', startTime, endTime);
  ...
  describe('getAllCalendarEvents', () => {
    it('fetches events from all calendars', async () => {
      ...
      mockCalendarClient.users.me.calendarList.get.mockResolvedValue(mockCalendars);
      mockCalendarClient.calendars.primary.events.get.mockResolvedValue(mockEvents);
